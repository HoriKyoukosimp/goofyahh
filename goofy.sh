  ...
  if [ "$numbers" -eq 1 ]; then
   ...
   while [ -z "$icon" ] || [ "$icon" != "1" ] && [ "$icon" != "2" ] && [ "$icon" != "3" ]; do
     ...
     if [ -n "$icon" ]; then
       ...
       if [ "$icon" == "1" ]; then
           # If the icon is "red", change custom-branding-any to "red"
         command="java -jar revanced-cli.jar -a YouTube.apk -c -b revanced-patches.jar -m inte.apk -i materialyou --experimental -o youtube_patched.apk -i custom-branding-name -i custom-branding-icon-red --keystore /data/data/com.termux/files/home/.keystore/revanced.keystore --custom-aapt2-binary=/data/data/com.termux/files/home/rvxtemp/aapt2"
       elif [ "$icon" == "2" ]; then
         # If the icon is "blue", change custom-branding-any to "blue"
         command="java -jar revanced-cli.jar -a YouTube.apk -c -b revanced-patches.jar -m inte.apk -i materialyou --experimental -o youtube_patched.apk -i custom-branding-name -i custom-branding-icon-blue --custom-aapt2-binary=/data/data/com.termux/files/home/rvxtemp/aapt2 --keystore /data/data/com.termux/files/home/.keystore/revanced.keystore"
       elif [ "$icon" == "3" ]; then
         # If the icon is "revancify", change custom-branding-any to "revancify"
         command="java -jar revanced-cli.jar -a YouTube.apk -c -b revanced-patches.jar -m inte.apk -i materialyou --experimental -o youtube_patched.apk -i custom-branding-name -i custom-branding-icon-revancify --custom-aapt2-binary=/data/data/com.termux/files/home/rvxtemp/aapt2 --keystore /data/data/com.termux/files/home/.keystore/revanced.keystore"
        elif [ "$icon" == "4" ]; then
         # If the icon is "revancify", change custom-branding-any to "og"
         command="java -jar revanced-cli.jar -a YouTube.apk -c -b revanced-patches.jar -m inte.apk -i materialyou --experimental --keystore /data/data/com.termux/files/home/.keystore/revanced.keystore -o youtube_patched.apk -i custom-branding-name -e custom-branding-icon-revancify -e custom-branding-icon-blue -e custom-branding-icon-red --custom-aapt2-binary=/data/data/com.termux/files/home/rvxtemp/aapt2"
       else
         # If the icon is something else, print an error message and set the icon variable to an empty string
         echo "Invalid icon color. Please try again."
         icon=""
